...
public class ListFoodServlet extends HttpServlet {
    ...
    private final String LISTFOOD_PAGE = "searchFood.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            foodsDAO.get20FoodFirst();
            List<FoodsDTO> listFood = foodsDAO.getLoadFoodList();
            url = LISTFOOD_PAGE;
            ...
            session.setAttribute("GETALLCATEGORY", listCate);
            request.setAttribute("GET20LISTFOODFIRST", listFood);

        } catch (SQLException ex) {
            log("ListFoodServlet_SQL: " + ex.getMessage());
        } catch (NamingException ex) {
            log("ListFoodServlet_NamingException: " + ex.getMessage());
        } finally {
